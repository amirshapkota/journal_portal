...
def save_user_profile(sender, instance, created, **kwargs):
    ...
    """
    # Skip if this is a newly created user (profile will be created by create_user_profile signal)
    if created:
        return
    ...
    if hasattr(instance, 'profile'):
        ...
        if not instance.profile.display_name or instance.profile.display_name == current_display:
            ...
            Profile.objects.filter(id=instance.profile.id).update(display_name=current_display)
